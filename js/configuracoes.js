...
function renderUsuarios() {
  ...
  // estar presente pro aviso ao vivo (o popup de canto, em
  // js/notificacoes.js). Some sozinho quando o último pendente for aprovado.
...
// ---- O aviso de novo cadastro MUDOU DE LUGAR (11/09/2026) -----------------
//
// Era um banner aqui dentro, e o Victor tirou: *"só aparece na tela de
// configurações, o que não ajuda muito pois é meio redundante ali"*. Quem já
// estava nesta tela tinha o card e a lista dizendo a mesma coisa; quem estava
// em qualquer outra não recebia nada. Hoje é um popup no canto da janela, em
// qualquer tela, em js/notificacoes.js.
//
// O CARD QUE PULSA continua aqui (ver renderUsuarios acima) e não é
// duplicação: ele é o ESTADO da fila -- "ainda tem alguém esperando?" -- e
// pega quem chega na tela depois. A notificação é o EVENTO.
